...
------
-----------------------------------------------------------------------------------------*/
#define LAN9252_SYNC0_PIN SYNC0_Pin
#define LAN9252_SYNC0_HANDLE SYNC0_EXTI_IRQn

#define INIT_SYNC0_INT()
#define DISABLE_SYNC0_INT() HAL_NVIC_DisableIRQ(LAN9252_SYNC0_HANDLE)
#define ENABLE_SYNC0_INT() HAL_NVIC_EnableIRQ(LAN9252_SYNC0_HANDLE)
...
------
-----------------------------------------------------------------------------------------*/
#define LAN9252_SYNC1_PIN SYNC1_Pin
#define LAN9252_SYNC1_HANDLE SYNC1_EXTI_IRQn

#define INIT_SYNC1_INT()
#define DISABLE_SYNC1_INT() HAL_NVIC_DisableIRQ(SYNC1_EXTI_IRQn)
#define ENABLE_SYNC1_INT() HAL_NVIC_EnableIRQ(SYNC1_EXTI_IRQn)
...
------
-----------------------------------------------------------------------------------------*/
#define LAN9252_TIM_HANDLE htim6
...
------
-----------------------------------------------------------------------------------------*/
#define LAN9252_IRQ_PIN IRQ_Pin
#define LAN9252_IRQ_HANDLE IRQ_EXTI_IRQn

#define INIT_ESC_INT()
#define DISABLE_ESC_INT()                        \
    {                                            \
        HAL_NVIC_DisableIRQ(LAN9252_IRQ_HANDLE); \
        DISABLE_SYNC0_INT();                     \
        DISABLE_SYNC1_INT();                     \
...
#define ENABLE_ESC_INT()                        \
    {                                           \
        HAL_NVIC_EnableIRQ(LAN9252_IRQ_HANDLE); \
        ENABLE_SYNC0_INT();                     \
        ENABLE_SYNC1_INT();                     \
