...
// 电机、编码器参数
#define PMSM_J (1.5E-4F)                            // 电机转动惯量
#define PMSM_Lp2p (0.31e-03F)                       // 相间电感
#define PMSM_Rp2p (0.09F)                           // 相间电阻
#define PMSM_RATED_CURRENT (3.0F)                   // 电机额定电流
#define PMSM_PEAK_CURRENT (9.0F)                    // 电机峰值电流
#define PMSM_PN (4.0F)                              // 极对数
#define PMSM_SPEED_MAX_RPM (4000.0F)                // 电机最大转速
#define PMSM_TORQUE_CONSTANT_MNM_A (130.0F)         // 电机转矩常数 mN*M/A
#define PMSM_ENC_LINE_ORG (4000u)                   // 电机端编码器原始分辨率
...
#define PMSM_LOAD_ENC_LINE_ORG (4000u)              // 负载端编码器原始分辨率
