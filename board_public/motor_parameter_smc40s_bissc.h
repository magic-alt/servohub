...
// 电机、编码器参数
#define PMSM_J (3.3E-6F)                            // 电机转动惯量
#define PMSM_Lp2p (1.9e-03F)                        // 相间电感
#define PMSM_Rp2p (1.5F)                            // 相间电阻
#define PMSM_RATED_CURRENT (3.2F)                   // 电机额定电流
#define PMSM_PEAK_CURRENT (9.6F)                    // 电机峰值电流
#define PMSM_PN (5.0F)                              // 极对数
#define PMSM_SPEED_MAX_RPM (4000.0F)                // 电机最大转速
#define PMSM_TORQUE_CONSTANT_MNM_A (50.0F)          // 电机转矩常数 mN*M/A
#define PMSM_ENC_LINE_ORG (524288u)                 // 电机端编码器原始分辨率
...
#define PMSM_LOAD_ENC_LINE_ORG (524288u)            // 负载端编码器原始分辨率
