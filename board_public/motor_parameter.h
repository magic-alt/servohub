...
#define PMSM_ENC_LINE_P_N (131072u)          // 电机端编码器单圈分辨率
#define PMSM_LOAD_ENC_LINE_P_N (131072u)     // 负载端编码器单圈分辨率
...
// 电流环参数
#define CURRENT_CTL_CONFIG_KP_LD (9.93e-01f)              // d轴电流环比例增益
#define CURRENT_CTL_CONFIG_KI_LD (1.07e+03f)              // d轴电流环积分增益
#define CURRENT_CTL_CONFIG_KP_LQ (9.93e-01f)              // q轴电流环比例增益
#define CURRENT_CTL_CONFIG_KI_LQ (1.07e+03f)              // q轴电流环积分增益
...
// 位置速度环参数
#define POS_SPEED_CTL_CONFIG_KP_P (5.92e+02f) // 位置环比例增益
#define POS_SPEED_CTL_CONFIG_KI_S (3.35e+01f) // 速度环积分增益
#define POS_SPEED_CTL_CONFIG_KP_S (4.32e-02f)  // 速度环比例增益
#define POS_SPEED_CTL_CONFIG_J_KT (1.46e-04f) // 惯性系数
