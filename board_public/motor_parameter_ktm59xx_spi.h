...
// 电机、编码器参数
#define PMSM_J (7.0E-6F)                            // 电机转动惯量
#define PMSM_Lp2p (6.98e-05F)                       // 相间电感
#define PMSM_Rp2p (2.76e-01F)                       // 相间电阻
#define PMSM_RATED_CURRENT (6.0F)                   // 电机额定电流
#define PMSM_PEAK_CURRENT (12.0F)                   // 电机峰值电流
#define PMSM_PN (21)                                // 极对数
#define PMSM_SPEED_MAX_RPM (2500.0F)                // 电机最大转速
#define PMSM_TORQUE_CONSTANT_MNM_A (168.64F)        // 电机转矩常数 mN*M/A
#define PMSM_ENC_LINE_ORG (16777216)                // 电机端编码器原始分辨率
#define PMSM_ENC_LINE_LESS_BITS (7)                 // 电机端编码器原始分辨率 降位位数
#define PMSM_ENC_LINE_P_N (PMSM_ENC_LINE_ORG >> \
                    PMSM_ENC_LINE_LESS_BITS)        // 电机端编码器实际分辨率
#define PMSM_LOAD_ENC_LINE_ORG (16777216)           // 负载端编码器原始分辨率
#define PMSM_LOAD_ENC_LINE_LESS_BITS (7)            // 负载端编码器原始分辨率 降位位数
...
// 减速比参数
#define GEAR_RATIO_NUM (10) // 减速比分子
