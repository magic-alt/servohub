...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, USER_IO5_Pin|USER_IO6_Pin|USER_IO7_Pin|DRV_EN_GATE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DRV_AF_SPI_NSS_Pin|FLASH_AF_SPI_NSS_Pin|USER_SPI_NSS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_RED_Pin|LED_BLUE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : USER_IO1_Pin USER_IO2_Pin USER_IO3_Pin USER_IO4_Pin */
  GPIO_InitStruct.Pin = USER_IO1_Pin|USER_IO2_Pin|USER_IO3_Pin|USER_IO4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : USER_IO5_Pin USER_IO6_Pin USER_IO7_Pin */
  GPIO_InitStruct.Pin = USER_IO5_Pin|USER_IO6_Pin|USER_IO7_Pin;
  ...
  /*Configure GPIO pins : ECAT_SYNC1_Pin ECAT_SYNC0_Pin ECAT_IRQ_Pin */
  GPIO_InitStruct.Pin = ECAT_SYNC1_Pin|ECAT_SYNC0_Pin|ECAT_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : DRV_AF_SPI_NSS_Pin FLASH_AF_SPI_NSS_Pin USER_SPI_NSS_Pin */
  GPIO_InitStruct.Pin = DRV_AF_SPI_NSS_Pin|FLASH_AF_SPI_NSS_Pin|USER_SPI_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
