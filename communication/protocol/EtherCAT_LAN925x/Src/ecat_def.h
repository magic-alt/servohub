...
#define STRUCT_PACKED_END                         __attribute__((aligned(2), packed))
#endif
...
#define MBX_STRUCT_PACKED_END                     __attribute__((aligned(2), packed))
#endif
...
#define MAX_PD_INPUT_SIZE                         0x2C //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x18 //This define was already evaluated by ET9300 Project Handler(V. 1.5.3.0)!
#endif
