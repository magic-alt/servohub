...
#define MAVLINK_MSG_ID_ElecAngleIdOutput 43
...
#define MAVLINK_MSG_ID_ElecAngleIdOutput_LEN 22
#define MAVLINK_MSG_ID_ElecAngleIdOutput_MIN_LEN 22
#define MAVLINK_MSG_ID_43_LEN 22
#define MAVLINK_MSG_ID_43_MIN_LEN 22

#define MAVLINK_MSG_ID_ElecAngleIdOutput_CRC 125
#define MAVLINK_MSG_ID_43_CRC 125
...
#define MAVLINK_MESSAGE_INFO_ElecAngleIdOutput { \
    ...
    {  { "id_tar_A", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_elecangleidoutput_t, id_tar_A) }, \
         ...
         { "pearson_r", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_elecangleidoutput_t, pearson_r) }, \
         { "state_now", NULL, MAVLINK_TYPE_INT8_T, 0, 20, offsetof(mavlink_elecangleidoutput_t, state_now) }, \
         { "elec_bias_buff_rad", NULL, MAVLINK_TYPE_FLOAT, 2, 12, offsetof(mavlink_elecangleidoutput_t, elec_bias_buff_rad) }, \
         { "step_num", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_elecangleidoutput_t, step_num) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ElecAngleIdOutput { \
...
static inline uint16_t mavlink_msg_elecangleidoutput_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float id_tar_A, float elec_bias_rad, float pearson_r, int8_t state_now, const float *elec_bias_buff_rad, uint8_t step_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ElecAngleIdOutput_LEN];
    _mav_put_float(buf, 0, id_tar_A);
    _mav_put_float(buf, 4, elec_bias_rad);
    _mav_put_float(buf, 8, pearson_r);
    _mav_put_int8_t(buf, 20, state_now);
    _mav_put_uint8_t(buf, 21, step_num);
    _mav_put_float_array(buf, 12, elec_bias_buff_rad, 2);
...
{
    return mavlink_msg_elecangleidoutput_pack(system_id, component_id, msg, elecangleidoutput->id_tar_A, elecangleidoutput->elec_bias_rad, elecangleidoutput->pearson_r, elecangleidoutput->state_now, elecangleidoutput->elec_bias_buff_rad, elecangleidoutput->step_num);
}
...
{
    return mavlink_msg_elecangleidoutput_pack_chan(system_id, component_id, chan, msg, elecangleidoutput->id_tar_A, elecangleidoutput->elec_bias_rad, elecangleidoutput->pearson_r, elecangleidoutput->state_now, elecangleidoutput->elec_bias_buff_rad, elecangleidoutput->step_num);
}
...
{
    return mavlink_msg_elecangleidoutput_pack_status(system_id, component_id, _status, msg,  elecangleidoutput->id_tar_A, elecangleidoutput->elec_bias_rad, elecangleidoutput->pearson_r, elecangleidoutput->state_now, elecangleidoutput->elec_bias_buff_rad, elecangleidoutput->step_num);
}
...
static inline void mavlink_msg_elecangleidoutput_send(mavlink_channel_t chan, float id_tar_A, float elec_bias_rad, float pearson_r, int8_t state_now, const float *elec_bias_buff_rad, uint8_t step_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ElecAngleIdOutput_LEN];
    _mav_put_float(buf, 0, id_tar_A);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_elecangleidoutput_send(chan, elecangleidoutput->id_tar_A, elecangleidoutput->elec_bias_rad, elecangleidoutput->pearson_r, elecangleidoutput->state_now, elecangleidoutput->elec_bias_buff_rad, elecangleidoutput->step_num);
#else
 ...
 */
static inline void mavlink_msg_elecangleidoutput_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float id_tar_A, float elec_bias_rad, float pearson_r, int8_t state_now, const float *elec_bias_buff_rad, uint8_t step_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field pearson_r from elecangleidoutput message
 *
 * @return  
 */
static inline float mavlink_msg_elecangleidoutput_get_pearson_r(const mavlink_message_t* msg)
{
...
{
    return _MAV_RETURN_float_array(msg, elec_bias_buff_rad, 2,  12);
}
...
static inline void mavlink_msg_elecangleidoutput_decode(const mavlink_message_t* msg, mavlink_elecangleidoutput_t* elecangleidoutput)
{
    ...
    elecangleidoutput->pearson_r = mavlink_msg_elecangleidoutput_get_pearson_r(msg);
