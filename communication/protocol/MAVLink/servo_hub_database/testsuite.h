/** @file
 *    @brief MAVLink comm protocol testsuite generated from servo_hub_database.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef SERVO_HUB_DATABASE_TESTSUITE_H
#define SERVO_HUB_DATABASE_TESTSUITE_H
...
static void mavlink_test_servo_hub_database(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

    mavlink_test_servo_hub_database(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_posspeedctlinput(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_posspeedctlinput_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_posspeedctlinput_pack(system_id, component_id, &msg , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.acc_tar_p_ss , packet1.speed_now_rad_s );
    mavlink_msg_posspeedctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_posspeedctlinput_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.acc_tar_p_ss , packet1.speed_now_rad_s );
    mavlink_msg_posspeedctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_posspeedctlinput_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_posspeedctlinput_send(MAVLINK_COMM_1 , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.acc_tar_p_ss , packet1.speed_now_rad_s );
    mavlink_msg_posspeedctlinput_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_currentctlinput(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_currentctlinput_t packet_in = {
        { 17.0, 18.0 },{ 73.0, 74.0, 75.0 },157.0,185.0,{ 213.0, 214.0, 215.0 },297.0,325.0,149
    };
    ...
    mavlink_msg_currentctlinput_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_currentctlinput_pack(system_id, component_id, &msg , packet1.idq_tar_A , packet1.iabc_now_A , packet1.elec_theta_rad , packet1.dc_bus_now_V , packet1.mode , packet1.uabc_tar_V , packet1.driver_temp , packet1.elec_angle_speed_rad_s );
    mavlink_msg_currentctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_currentctlinput_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.idq_tar_A , packet1.iabc_now_A , packet1.elec_theta_rad , packet1.dc_bus_now_V , packet1.mode , packet1.uabc_tar_V , packet1.driver_temp , packet1.elec_angle_speed_rad_s );
    mavlink_msg_currentctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_currentctlinput_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_currentctlinput_send(MAVLINK_COMM_1 , packet1.idq_tar_A , packet1.iabc_now_A , packet1.elec_theta_rad , packet1.dc_bus_now_V , packet1.mode , packet1.uabc_tar_V , packet1.driver_temp , packet1.elec_angle_speed_rad_s );
    mavlink_msg_currentctlinput_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_elecangleidinput(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_elecangleidinput_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.id_now_A = packet_in.id_now_A;
    ...
    mavlink_msg_elecangleidinput_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidinput_pack(system_id, component_id, &msg , packet1.id_now_A , packet1.pos_now_rad );
    mavlink_msg_elecangleidinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidinput_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.id_now_A , packet1.pos_now_rad );
    mavlink_msg_elecangleidinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_elecangleidinput_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidinput_send(MAVLINK_COMM_1 , packet1.id_now_A , packet1.pos_now_rad );
    mavlink_msg_elecangleidinput_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_elecangleidconfig(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_elecangleidconfig_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.id_sin_amp_A = packet_in.id_sin_amp_A;
        packet1.dt_s = packet_in.dt_s;
        packet1.id_sin_w_Hz = packet_in.id_sin_w_Hz;
        packet1.search_gain = packet_in.search_gain;
    ...
    mavlink_msg_elecangleidconfig_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidconfig_pack(system_id, component_id, &msg , packet1.id_sin_amp_A , packet1.dt_s , packet1.id_sin_w_Hz , packet1.search_gain , packet1.method , packet1.angle_add_rad , packet1.wait_time_s , packet1.test_angle_rad , packet1.current_slope_percentage );
    mavlink_msg_elecangleidconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidconfig_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.id_sin_amp_A , packet1.dt_s , packet1.id_sin_w_Hz , packet1.search_gain , packet1.method , packet1.angle_add_rad , packet1.wait_time_s , packet1.test_angle_rad , packet1.current_slope_percentage );
    mavlink_msg_elecangleidconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_elecangleidconfig_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidconfig_send(MAVLINK_COMM_1 , packet1.id_sin_amp_A , packet1.dt_s , packet1.id_sin_w_Hz , packet1.search_gain , packet1.method , packet1.angle_add_rad , packet1.wait_time_s , packet1.test_angle_rad , packet1.current_slope_percentage );
    mavlink_msg_elecangleidconfig_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_elecangleidoutput(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_elecangleidoutput_t packet_in = {
        17.0,45.0,73.0,{ 101.0, 102.0 },65,132
    };
    mavlink_elecangleidoutput_t packet1, packet2;
        ...
        packet1.pearson_r = packet_in.pearson_r;
        packet1.state_now = packet_in.state_now;
    ...
    mavlink_msg_elecangleidoutput_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidoutput_pack(system_id, component_id, &msg , packet1.id_tar_A , packet1.elec_bias_rad , packet1.pearson_r , packet1.state_now , packet1.elec_bias_buff_rad , packet1.step_num );
    mavlink_msg_elecangleidoutput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidoutput_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.id_tar_A , packet1.elec_bias_rad , packet1.pearson_r , packet1.state_now , packet1.elec_bias_buff_rad , packet1.step_num );
    mavlink_msg_elecangleidoutput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_elecangleidoutput_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_elecangleidoutput_send(MAVLINK_COMM_1 , packet1.id_tar_A , packet1.elec_bias_rad , packet1.pearson_r , packet1.state_now , packet1.elec_bias_buff_rad , packet1.step_num );
    mavlink_msg_elecangleidoutput_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_appencoderconfig(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_appencoderconfig_t packet1, packet2;
        ...
        packet1.Encoder_options = packet_in.Encoder_options;
    ...
    mavlink_msg_appencoderconfig_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appencoderconfig_pack(system_id, component_id, &msg , packet1.Load_encoder_resolution , packet1.Motor_encoder_resolution , packet1.Motor_encoder_type , packet1.Load_encoder_type , packet1.Encoder_options , packet1.Load_pps_2_rpm , packet1.Load_rpm_2_pps );
    mavlink_msg_appencoderconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appencoderconfig_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Load_encoder_resolution , packet1.Motor_encoder_resolution , packet1.Motor_encoder_type , packet1.Load_encoder_type , packet1.Encoder_options , packet1.Load_pps_2_rpm , packet1.Load_rpm_2_pps );
    mavlink_msg_appencoderconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_appencoderconfig_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appencoderconfig_send(MAVLINK_COMM_1 , packet1.Load_encoder_resolution , packet1.Motor_encoder_resolution , packet1.Motor_encoder_type , packet1.Load_encoder_type , packet1.Encoder_options , packet1.Load_pps_2_rpm , packet1.Load_rpm_2_pps );
    mavlink_msg_appencoderconfig_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_appmotioninfo(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_appmotioninfo_t packet_in = {
        93372036854775807LL,93372036854776311LL,93372036854776815LL,93372036854777319LL,93372036854777823LL,93372036854778327LL,93372036854778831LL,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,801.0,23267,23371,23475
    };
...
static void mavlink_test_mitctlinput(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_mitctlinput_t packet1, packet2;
        ...
        packet1.pos_tar_p = packet_in.pos_tar_p;
        packet1.pos_now_p = packet_in.pos_now_p;
        packet1.tq_set_A = packet_in.tq_set_A;
        packet1.iq_max_A = packet_in.iq_max_A;
        packet1.speed_tar_p_s = packet_in.speed_tar_p_s;
        packet1.speed_now_rad_s = packet_in.speed_now_rad_s;
    ...
    mavlink_msg_mitctlinput_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlinput_pack(system_id, component_id, &msg , packet1.tq_set_A , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.speed_now_rad_s );
    mavlink_msg_mitctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlinput_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.tq_set_A , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.speed_now_rad_s );
    mavlink_msg_mitctlinput_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mitctlinput_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlinput_send(MAVLINK_COMM_1 , packet1.tq_set_A , packet1.pos_tar_p , packet1.pos_now_p , packet1.iq_max_A , packet1.speed_tar_p_s , packet1.speed_now_rad_s );
    mavlink_msg_mitctlinput_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_mitctlconfig(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_mitctlconfig_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.kp_pos_rad_A = packet_in.kp_pos_rad_A;
        packet1.kd_spd_rad_s_A = packet_in.kd_spd_rad_s_A;
        packet1.enc_line_inv_p_n = packet_in.enc_line_inv_p_n;
    ...
    mavlink_msg_mitctlconfig_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlconfig_pack(system_id, component_id, &msg , packet1.kp_pos_rad_A , packet1.kd_spd_rad_s_A , packet1.enc_line_inv_p_n );
    mavlink_msg_mitctlconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlconfig_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.kp_pos_rad_A , packet1.kd_spd_rad_s_A , packet1.enc_line_inv_p_n );
    mavlink_msg_mitctlconfig_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mitctlconfig_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mitctlconfig_send(MAVLINK_COMM_1 , packet1.kp_pos_rad_A , packet1.kd_spd_rad_s_A , packet1.enc_line_inv_p_n );
    mavlink_msg_mitctlconfig_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_appdebugparam(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_appdebugparam_t packet_in = {
        { 17.0, 18.0, 19.0, 20.0, 21.0, 22.0, 23.0, 24.0, 25.0, 26.0, 27.0, 28.0, 29.0, 30.0, 31.0, 32.0 },{ 963500792, 963500793, 963500794, 963500795, 963500796, 963500797, 963500798, 963500799, 963500800, 963500801, 963500802, 963500803, 963500804, 963500805, 963500806, 963500807 }
    };
    ...
    mavlink_msg_appdebugparam_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appdebugparam_pack(system_id, component_id, &msg , packet1.Debug_float , packet1.Debug_uint32 );
    mavlink_msg_appdebugparam_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appdebugparam_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Debug_float , packet1.Debug_uint32 );
    mavlink_msg_appdebugparam_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_appdebugparam_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_appdebugparam_send(MAVLINK_COMM_1 , packet1.Debug_float , packet1.Debug_uint32 );
    mavlink_msg_appdebugparam_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
#endif // __cplusplus
#endif // SERVO_HUB_DATABASE_TESTSUITE_H
