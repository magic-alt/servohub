...
typedef struct __mavlink_mitctlconfig_t {
 float kp_pos_rad_A; /*<  */
 float kd_spd_rad_s_A; /*<  */
 float enc_line_inv_p_n; /*<  */
} mavlink_mitctlconfig_t;

#define MAVLINK_MSG_ID_MitCtlConfig_LEN 12
#define MAVLINK_MSG_ID_MitCtlConfig_MIN_LEN 12
#define MAVLINK_MSG_ID_75_LEN 12
#define MAVLINK_MSG_ID_75_MIN_LEN 12

#define MAVLINK_MSG_ID_MitCtlConfig_CRC 119
#define MAVLINK_MSG_ID_75_CRC 119
...
#define MAVLINK_MESSAGE_INFO_MitCtlConfig { \
    ...
    "MitCtlConfig", \
    3, \
    {  { "kp_pos_rad_A", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_mitctlconfig_t, kp_pos_rad_A) }, \
         { "kd_spd_rad_s_A", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_mitctlconfig_t, kd_spd_rad_s_A) }, \
...
static inline uint16_t mavlink_msg_mitctlconfig_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float kp_pos_rad_A, float kd_spd_rad_s_A, float enc_line_inv_p_n)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MitCtlConfig_LEN];
    _mav_put_float(buf, 0, kp_pos_rad_A);
    _mav_put_float(buf, 4, kd_spd_rad_s_A);
    ...
    packet.kp_pos_rad_A = kp_pos_rad_A;
    packet.kd_spd_rad_s_A = kd_spd_rad_s_A;
...
{
    return mavlink_msg_mitctlconfig_pack(system_id, component_id, msg, mitctlconfig->kp_pos_rad_A, mitctlconfig->kd_spd_rad_s_A, mitctlconfig->enc_line_inv_p_n);
}
...
{
    return mavlink_msg_mitctlconfig_pack_chan(system_id, component_id, chan, msg, mitctlconfig->kp_pos_rad_A, mitctlconfig->kd_spd_rad_s_A, mitctlconfig->enc_line_inv_p_n);
}
...
{
    return mavlink_msg_mitctlconfig_pack_status(system_id, component_id, _status, msg,  mitctlconfig->kp_pos_rad_A, mitctlconfig->kd_spd_rad_s_A, mitctlconfig->enc_line_inv_p_n);
}
...
static inline void mavlink_msg_mitctlconfig_send(mavlink_channel_t chan, float kp_pos_rad_A, float kd_spd_rad_s_A, float enc_line_inv_p_n)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MitCtlConfig_LEN];
    _mav_put_float(buf, 0, kp_pos_rad_A);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mitctlconfig_send(chan, mitctlconfig->kp_pos_rad_A, mitctlconfig->kd_spd_rad_s_A, mitctlconfig->enc_line_inv_p_n);
#else
 ...
 */
static inline void mavlink_msg_mitctlconfig_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float kp_pos_rad_A, float kd_spd_rad_s_A, float enc_line_inv_p_n)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field kp_pos_rad_A from mitctlconfig message
 *
 * @return  
 */
static inline float mavlink_msg_mitctlconfig_get_kp_pos_rad_A(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field kd_spd_rad_s_A from mitctlconfig message
 *
 * @return  
 */
static inline float mavlink_msg_mitctlconfig_get_kd_spd_rad_s_A(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mitctlconfig->kp_pos_rad_A = mavlink_msg_mitctlconfig_get_kp_pos_rad_A(msg);
    mitctlconfig->kd_spd_rad_s_A = mavlink_msg_mitctlconfig_get_kd_spd_rad_s_A(msg);
