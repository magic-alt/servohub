...
#define MAVLINK_MSG_ID_MitCtlConfig_CRC 95
#define MAVLINK_MSG_ID_75_CRC 95
...
#define MAVLINK_MESSAGE_INFO_MitCtlConfig { \
    ...
    "MitCtlConfig", \
    4, \
    {  { "kp_pos_rad_NM", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_mitctlconfig_t, kp_pos_rad_NM) }, \
         { "kd_spd_rad_s_NM", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_mitctlconfig_t, kd_spd_rad_s_NM) }, \
...
static inline uint16_t mavlink_msg_mitctlconfig_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float kp_pos_rad_NM, float kd_spd_rad_s_NM, float enc_line_inv_p_n, float kt_NM_A)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MitCtlConfig_LEN];
    _mav_put_float(buf, 0, kp_pos_rad_NM);
    _mav_put_float(buf, 4, kd_spd_rad_s_NM);
    ...
    packet.kp_pos_rad_NM = kp_pos_rad_NM;
    packet.kd_spd_rad_s_NM = kd_spd_rad_s_NM;
...
{
    return mavlink_msg_mitctlconfig_pack(system_id, component_id, msg, mitctlconfig->kp_pos_rad_NM, mitctlconfig->kd_spd_rad_s_NM, mitctlconfig->enc_line_inv_p_n, mitctlconfig->kt_NM_A);
}
...
{
    return mavlink_msg_mitctlconfig_pack_chan(system_id, component_id, chan, msg, mitctlconfig->kp_pos_rad_NM, mitctlconfig->kd_spd_rad_s_NM, mitctlconfig->enc_line_inv_p_n, mitctlconfig->kt_NM_A);
}
...
{
    return mavlink_msg_mitctlconfig_pack_status(system_id, component_id, _status, msg,  mitctlconfig->kp_pos_rad_NM, mitctlconfig->kd_spd_rad_s_NM, mitctlconfig->enc_line_inv_p_n, mitctlconfig->kt_NM_A);
}
...
static inline void mavlink_msg_mitctlconfig_send(mavlink_channel_t chan, float kp_pos_rad_NM, float kd_spd_rad_s_NM, float enc_line_inv_p_n, float kt_NM_A)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MitCtlConfig_LEN];
    _mav_put_float(buf, 0, kp_pos_rad_NM);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mitctlconfig_send(chan, mitctlconfig->kp_pos_rad_NM, mitctlconfig->kd_spd_rad_s_NM, mitctlconfig->enc_line_inv_p_n, mitctlconfig->kt_NM_A);
#else
 ...
 */
static inline void mavlink_msg_mitctlconfig_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float kp_pos_rad_NM, float kd_spd_rad_s_NM, float enc_line_inv_p_n, float kt_NM_A)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field kp_pos_rad_NM from mitctlconfig message
 *
 * @return  
 */
static inline float mavlink_msg_mitctlconfig_get_kp_pos_rad_NM(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  0);
}

/**
 * @brief Get field kd_spd_rad_s_NM from mitctlconfig message
 *
 * @return  
 */
static inline float mavlink_msg_mitctlconfig_get_kd_spd_rad_s_NM(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mitctlconfig->kp_pos_rad_NM = mavlink_msg_mitctlconfig_get_kp_pos_rad_NM(msg);
    mitctlconfig->kd_spd_rad_s_NM = mavlink_msg_mitctlconfig_get_kd_spd_rad_s_NM(msg);
