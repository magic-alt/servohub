...
#define MAVLINK_MSG_ID_AppDebugParam 91
...
#define MAVLINK_MSG_ID_AppDebugParam_LEN 128
#define MAVLINK_MSG_ID_AppDebugParam_MIN_LEN 128
#define MAVLINK_MSG_ID_91_LEN 128
#define MAVLINK_MSG_ID_91_MIN_LEN 128

#define MAVLINK_MSG_ID_AppDebugParam_CRC 44
#define MAVLINK_MSG_ID_91_CRC 44
...
static inline uint16_t mavlink_msg_appdebugparam_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const float *Debug_float, const uint32_t *Debug_uint32)
{
...
{
    return mavlink_msg_appdebugparam_pack(system_id, component_id, msg, appdebugparam->Debug_float, appdebugparam->Debug_uint32);
}
...
{
    return mavlink_msg_appdebugparam_pack_chan(system_id, component_id, chan, msg, appdebugparam->Debug_float, appdebugparam->Debug_uint32);
}
...
{
    return mavlink_msg_appdebugparam_pack_status(system_id, component_id, _status, msg,  appdebugparam->Debug_float, appdebugparam->Debug_uint32);
}
...
static inline void mavlink_msg_appdebugparam_send(mavlink_channel_t chan, const float *Debug_float, const uint32_t *Debug_uint32)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_AppDebugParam_LEN];
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_appdebugparam_send(chan, appdebugparam->Debug_float, appdebugparam->Debug_uint32);
#else
 ...
 */
static inline void mavlink_msg_appdebugparam_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const float *Debug_float, const uint32_t *Debug_uint32)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
