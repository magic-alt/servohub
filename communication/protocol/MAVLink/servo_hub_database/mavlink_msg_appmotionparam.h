...
/**
 * @brief Get field Emergency_brake_requested from appmotionparam message
 *
 * @return  
 */
static inline uint8_t mavlink_msg_appmotionparam_get_Emergency_brake_requested(const mavlink_message_t* msg)
{
