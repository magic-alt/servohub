...
typedef UNS32 (*OD_Write_Callback_p)(uint16_t index, uint8_t subindex, void *data);
typedef UNS32 (*OD_Read_Callback_p) (uint16_t index, uint8_t subindex, void *data);

extern OD_Write_Callback_p  OD_Write_Callback;
extern OD_Read_Callback_p   OD_Read_Callback;
#ifdef __cplusplus
};
#endif
